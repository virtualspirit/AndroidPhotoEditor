...
import com.virtualspirit.photoeditor.TextStyleBuilder.TextStyle
import com.virtualspirit.photoeditor.shape.AbstractShape
import com.virtualspirit.photoeditor.shape.ShapeBuilder
import com.virtualspirit.photoeditor.shape.ShapeView
...
internal class PhotoEditorImpl @SuppressLint("ClickableViewAccessibility") constructor(
    ...
    override fun isSelectedViewColorEditable(): Boolean {
        val view = viewState.currentSelectedView ?: return false
        val type = viewTypeFromTag(view)
        return type == ViewType.SHAPE || type == ViewType.BRUSH_DRAWING
    }

    override fun getSelectedViewColor(): Int? {
